    ...
    while True:
        ...
        if categoria_elegida in Palabras:
            ...
            if not palabras_validas:
                print(f"No hay suficientes palabras válidas en la categoría {categoria_elegida}. Elija otra categoría.")
                continue

            palabras_a_encontrar = random.sample(palabras_validas, min(cantidad, len(palabras_validas)))
            print()
            ...
            # Aquí agregamos las palabras al tablero
            matriz_letras = RellenarLetras(palabras_a_encontrar, filas, columnas)
